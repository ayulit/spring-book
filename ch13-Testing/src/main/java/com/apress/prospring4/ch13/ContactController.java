...
@Controller // this class is controller Spring MVC
@RequestMapping(value="/contact") // will be process all URLs begin from http://localhost:8080/ch12/contact
public class ContactController {
	final Logger logger = LoggerFactory.getLogger(ContactController.class);
	
	@Autowired // ContactService automatically connected with controller
	private ContactService contactService;
	
	// http://localhost:8080/ch12/contact/listdata
